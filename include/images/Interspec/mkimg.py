...
for FileName in Imgs:
	...
	try:
		...
		# Modules
		metadata['Exif.Image.Software'] = "apogee"
		# Experiment
		metadata['Exif.Image.Make'] = "20180807b"

	
		metadata['Exif.Photo.MakerNote'] = "hacking"
		# Description
		metadata['Exif.Image.ImageDescription'] = "Exploring the innards of an InterspecApogee probe"
