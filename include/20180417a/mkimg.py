...
for FileName in Imgs:
	...
	try:
		...
		# Modules
		metadata['Exif.Image.Software'] = "elmo, matty, tomtom, alt.tbo, doj, goblin, cletus"
		# Experiment
		metadata['Exif.Image.Make'] = "20180417a"
		...
		if "DAT_rawsignal" in FileName:
			...
			# Description
			metadata['Exif.Image.ImageDescription'] = "Comparing files"
		# Saving the image
