...
for FileName in Imgs:
	...
	try:
		...
		# Modules
		metadata['Exif.Image.Software'] = "hp2121"
		# Experiment
		metadata['Exif.Image.Make'] = "20200808r"

		metadata['Exif.Photo.MakerNote'] = "s1p"
		# Description
		metadata['Exif.Image.ImageDescription'] = "Reviewing hp2121 values"
		# Saving the image
