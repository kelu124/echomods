...
'''Description: Autotagging images for the `20180225a` experiment.'''
...
for FileName in Imgs:
	...
	try:
		...
		if "line" in FileName:
			...
			# Description
			metadata['Exif.Image.ImageDescription'] = "Review of the signal"
		elif "probe" in FileName:
			metadata['Exif.Photo.MakerNote'] = "ASC"
			# Description
			metadata['Exif.Image.ImageDescription'] = "After the scan conversion"
		elif "raw" in FileName:
			metadata['Exif.Photo.MakerNote'] = "BSC"
			# Description
			metadata['Exif.Image.ImageDescription'] = "Before scan conversion"
