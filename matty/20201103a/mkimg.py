...
for FileName in Imgs:
	...
	try:
		...
		# Experiment
		metadata['Exif.Image.Make'] = "20201103a"

		# Type of picture
		# Type of picture
		metadata['Exif.Photo.MakerNote'] = "graph"
		# Description
		metadata['Exif.Image.ImageDescription'] = "Impedance matching experiment"


		if "P_" in FileName:
			metadata['Exif.Photo.MakerNote'] = "setup"
			# Description
			metadata['Exif.Image.ImageDescription'] = "Impedance matching details"
