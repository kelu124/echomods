...
'''Description: Autotagging images for the `20180224b` experiment.'''
...
for FileName in Imgs:
	...
	try:
		...
		if "fft" in FileName:
			...
			# Description
			metadata['Exif.Image.ImageDescription'] = "Spectrum review 20180224b experiment"
		...
		elif "comparing_gain.jpg" in FileName:
			metadata['Exif.Photo.MakerNote'] = "graph"
			# Description
			metadata['Exif.Image.ImageDescription'] = "Comparing gains"
