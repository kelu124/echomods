...
for FileName in Imgs:
	...
	try:
		...
		# Modules
		metadata['Exif.Image.Software'] = "piezo,matty"
		# Experiment
		metadata['Exif.Image.Make'] = "20180814a"

	
		metadata['Exif.Photo.MakerNote'] = "graph"
		# Description
		metadata['Exif.Image.ImageDescription'] = "Testing a tentative acquisition at 128Msps by interleaving two acquisitions"
