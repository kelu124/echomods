...
|croaker|<ul><li>Choose the platform (BBB, RPi0, STM32, ... ?)</li><li>Getting some codes</li><li>Getting some images</li><li>Getting images onto a screen</li></ul>|<ul><li>Nothing</li></ul>|<ul><li>??</li></ul>|20% |
