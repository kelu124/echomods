...
|retroATL3|<ul><li>Finding the pins mapping</li><li>Motor in action</li><li>Insert a video =)</li><li>Get pictures</li></ul>|<ul><li>Refill Oil</li><li>Test echoes</li><li>Make Videos</li></ul>|<ul><li>?</li></ul>|42% |
|kina|<ul><li>Get the code up and running</li><li>Try to get the pulser there as well (timers)</li><li>Get several samples per position to average then stream</li><li>Output data to a 128x64 OLED screen</li></ul>|<ul><li>TODO</li></ul>|<ul><li>Kelu</li></ul>|20% |
...
|silent|<ul><li></li></ul>|<ul><li></li></ul>|<ul><li>Kelu</li></ul>|50% |
