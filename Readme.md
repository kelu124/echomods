...
|croaker|<ul><li>Replace the work done by <a href="/oneeye/">OneEye</a> by <a href="/croaker/">Croaker</a>.</li><li>Get better total ADC speed with an iterleaved move</li><li>See how to compress data</li></ul>|<ul><li>Choose the platform (BBB, RPi0, STM32, ... ?) : that'll be a <code>Feather WICED</code></li><li>Getting some images</li><li>Getting images onto a screen</li></ul>|50% |
