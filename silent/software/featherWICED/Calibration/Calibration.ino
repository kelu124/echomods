...
void emulator() {
  ...
  for ( i = 128; i > 0; i-- )
  {
    dac_write_channel(DAC, DAC_CH1, 256 + 2*i);
    dac_write_channel(DAC, DAC_CH1, 256 + 2*i);
    dac_write_channel(DAC, DAC_CH1, 256 + 2*i);
    dac_write_channel(DAC, DAC_CH1, 256 + 2*i);
  }
  ...
  dac_write_channel(DAC, DAC_CH1, 256+2*128);
  dac_write_channel(DAC, DAC_CH1, 256+2*128);
  ...
  dac_write_channel(DAC, DAC_CH1, 256+2*64);
  dac_write_channel(DAC, DAC_CH1, 256+2*64);
  dac_write_channel(DAC, DAC_CH1, 256+2*64);
  dac_write_channel(DAC, DAC_CH1, 256+2*64);
  ...
  dac_write_channel(DAC, DAC_CH1, 256+2*32);
  dac_write_channel(DAC, DAC_CH1, 256+2*32);
  dac_write_channel(DAC, DAC_CH1, 256+2*32);
  dac_write_channel(DAC, DAC_CH1, 256+2*32);
  dac_write_channel(DAC, DAC_CH1, 256+2*32);
